...
class PrizeCategoryController extends AdminBaseController
{
    /**
     * 文章分类列表
     * @adminMenu(
    ...
    public function addPost()
    {
        ...
        $result = $this->validate($data, 'app\portal\validate\PortalCategoryValidate');
        ...
        $this->success('添加成功!', url('PrizeCategory/index'));
